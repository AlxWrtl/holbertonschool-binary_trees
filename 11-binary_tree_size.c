 ...
 *              the total number of nodes in the tree. The size is determined by recursively
 *              summing the size of the left and right subtrees, adding 1 for the current node.
